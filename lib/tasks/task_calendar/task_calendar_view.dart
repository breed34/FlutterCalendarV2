import 'package:calendar_v2/tasks/task_calendar/calendar_widget/calendar_widget.dart';
import 'package:calendar_v2/tasks/task_calendar/task_calendar_presenter.dart';
import 'package:calendar_v2/tasks/task_scaffold.dart';
  ...
  Widget build(BuildContext context) {
    return TaskScaffold(
      ...
      actions: [
        IconButton(
          onPressed: () {
            Navigator.of(context).pushNamed('/tasks/prioritizer');
          },
